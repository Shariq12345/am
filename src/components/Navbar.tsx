        ...
        <div className="flex items-center justify-between h-16 lg:h-20 px-4 md:px-6 lg:px-20 w-full">
          ...
          <div className="flex items-center space-x-3">
            <Button
              ...
              className="hidden lg:flex bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white px-6 py-6 rounded-md shadow-lg hover:shadow-xl transition-all duration-200 text-base font-semibold cursor-pointer"
            >
              Get in Touch
            </Button>
